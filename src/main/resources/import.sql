...
VALUES
  (1, 'Raccoon.World - gadgets for hands', 1, 1, 400000, '2017-05-20 14:30:30.069', '2017-05-20 15:30:30.069', 50000, 'Raccoon.World is a company that creates gadgets for hands, based on spatialization, tracking, reproduction of fine motor skills and tactile perception.
Raccoon.world is an international company incorporated in Delaware, USA with R&D Center in Ukraine.', 'goal', 'start'),
  (2, 'Integrating Virtuality into Reality, Game', 1, 1, 150000, '2017-05-20 14:30:30.069', '2017-05-20 15:30:30.069', 50000,
      ...
      'start'),
  (3, 'Wood Pellets Storage', 1, 2, '1800000', '2017-05-20 14:30:30.069', '2017-05-20 15:30:30.069', 60000, 'European winter storage
All math and figures are taken from personal experience obtained during last year
Pellets sales market- Europe', 'goal', 'start'),
  (4, 'Virtual Insurance Agents (chatbots) for insurers', 1, 2, 400000, '2017-05-20 14:30:30.069', '2017-05-20 15:30:30.069', 20000,
      'We are building Virtual Insurance Agents (chatbots) to help insurers to engage their customers via Facebook Messengers.',
      'goal', 'middle'),
  (5, 'Appio', 1, 3, 500000, '2017-05-20 14:30:30.069', '2017-05-20 15:30:30.069', 25000,
      ...
      'goal', 'middle'),
  (6, 'Coliving Hub', 2, 1, 450000, '2017-05-20 14:30:30.069', '2017-05-20 15:30:30.069', 100000,
      'Affordable housing in San Francisco for digital nomads', 'goal', 'middle'),
  (7, 'Service for converting audio format to text format', 2, 1, 300000, '2017-05-20 14:30:30.069', '2017-05-20 15:30:30.069', 30000,
      ...
      'goal', 'middle'),
  (8, 'global marketplace for tutoring', 2, 2, 5000000, '2017-05-20 14:30:30.069', '2017-05-20 15:30:30.069', 500000,
      'a global marketplace for tutoring that is launched in 5 countries.', 'goal', 'finish'),
  (9, 'Kevuru Games', 2, 1, 100000, '2017-05-20 14:30:30.069', '2017-05-20 15:30:30.069', 10000,
      'Mobile games development with focus on strategy, match 3 and slots games categories', 'goal', 'finish'),
  (10, 'ebooks', 2, 2, 5000, '2017-05-20 14:30:30.069', '2017-05-20 15:30:30.069', 2500,
...
INSERT INTO startup_platform.investments (id, user_id, project_id, date, sum, verified, paid) VALUES
  (1, 1, 1, '2017-05-20 15:30:30.069', 50000, TRUE, TRUE),
  (2, 1, 2, '2017-05-20 15:30:30.069', 50000, TRUE, TRUE),
  (3, 1, 3, '2017-05-20 15:30:30.069', 60000, TRUE, TRUE),
  (4, 1, 4, '2017-05-20 15:30:30.069', 20000, TRUE, TRUE),
  (5, 1, 5, '2017-05-20 15:30:30.069', 25000, TRUE, TRUE),
  (6, 2, 6, '2017-05-20 15:30:30.069', 100000, TRUE, TRUE),
  (7, 2, 7, '2017-05-20 15:30:30.069', 30000, TRUE, TRUE),
  (8, 2, 8, '2017-05-20 15:30:30.069', 500000, TRUE, TRUE),
  (9, 2, 9, '2017-05-20 15:30:30.069', 10000, TRUE, TRUE),
  (10, 2, 10, '2017-05-20 15:30:30.069', 2500, TRUE, TRUE);
