...
-- --   ----------------------------------------------------------------------------------------------
INSERT INTO `users` (`id`, `type_id`, `name`, `email`, `password`) VALUES(1, 3, 'Admin', 'admin@admin.admin', '$2a$10$3NAgFi3tu7iO76jnzKdxg.dT0YbiDpoyPbcKPtIC7iupjmc3ziFiu'),(2, 3, 'User', 'user@user.user', '$2a$10$DDb4kmE5su.kXx7ku11slubKGBoQfEaCdSxIGokN7QUa46ync48o2');
...
-- --  Fill projects table
-- --   ----------------------------------------------------------------------------------------------
INSERT INTO `projects` (`id`, `name`, `owner_id`, `category_id`, `cost`, `date_added`, `date_start`, `min_invest`, `description`, `goal`, `stage`) VALUES(1, 'Raccoon.World - gadgets for hands', 1, 1, 400000, '2017-05-20 14:30:30.069', '2017-05-20 15:30:30.069', 50000, 'Raccoon.World is a company that creates gadgets for hands, based on spatialization, tracking, reproduction of fine motor skills and tactile perception.
Raccoon.world is an international company incorporated in Delaware, USA with R&D Center in Ukraine.', 'goal', 'start'),(2, 'Integrating Virtuality into Reality, Game', 1, 1, 150000, '2017-05-20 14:30:30.069', '2017-05-20 15:30:30.069', 50000,
