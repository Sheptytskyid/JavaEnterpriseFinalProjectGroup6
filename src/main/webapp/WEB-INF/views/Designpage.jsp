...
<div class="navbar navbar-default navbar-fixed-top">
    <div class="container">
        <div class="navbar-header">
            ...
            <a class="navbar-brand" href="#">Great<i class="fa fa-rocket fa-lg" aria-hidden="true"></i>Start </a>
        </div>
        <div class="collapse navbar-collapse" id="responsive-menu">
            ...
            <ul class="nav navbar-nav navbar-right">
                <!--<li class="active"><a  class="btn btn-success btn-md" href="#modal-login" data-toggle="modal" >Login</a></li>-->
