    ...
    <div class="row">
        <div class="col-xs-12">
            <div class="panel panel-success" style="border: 0;">
                <div class="panel-heading" style="border: 0; background: #f5f5f5">
...
<div class="container">
    <div class="row">
        <div class="col-xs-12">
            <div class="panel panel-success" style="background: #f5f5f5; border: 0">
                <div class="panel-body" >
                    ...
                    <form class="form-horizontal">
                        <fieldset>
                            ...
                            <div class="form-group">
                                <label class="col-md-4 control-label" for="OptionInterest">What do you want to
                                    invest
                                    in?</label>
                                <div class="col-md-4">
