    ...
    <form:form method="POST" modelAttribute="dtoUserProfile" class="form-signin">
        ...
        <spring:bind path="address">
            <div class="form-group">
                <form:textarea type="text" path="address" class="form-control" placeholder="Address"></form:textarea>
            </div>
        </spring:bind>

        <spring:bind path="phoneNumber">
            <div class="form-group">
                <form:input type="text" path="phoneNumber" class="form-control" placeholder="Phone"></form:input>
            </div>
        </spring:bind>
