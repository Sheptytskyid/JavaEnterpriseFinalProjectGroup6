...
<div class="container">
    <div class="col-xs-12">
        <div class="bs-calltoaction bs-calltoaction-success">
            <div class="row">
                <div class="col-md-5 cta-contents">
                    <h1 class="cta-title">Add new Project</h1>
                    <div class="cta-desc">
                    ...
                    <form class="form-horizontal" action="" method="" id="addProject">
                        <fieldset>
                            <div class="form-group col-md-6">
                                <div class="col-md-12">
                                    <input id="ProjectName" name="ProjectName" type="text" placeholder="Enter project name"
                                           class="form-control input-md input-text">
                                </div>
                            </div>
                            <div class="col-md-6 cta-button cta-form">
        ...
        <div class="bs-calltoaction bs-calltoaction-success">
            <div class="row">
                <div class="col-md-5 cta-contents">
                    <h1 class="cta-title">Add new Interest</h1>
                    <div class="cta-desc">
                        <p>Describe the action here.</p>
                        <p>Describe the action here.</p>
                        <p>Describe the action here.</p>
                ...
                <div class="col-md-7">
                    <div>
                        <form class="form-horizontal" action="" method="" id="addInterest">
                            <div class="col-md-6">
                                <select id="addInterestOption" class="form-group select-input" title="What do you want to invest in?">
                            ...
                            <div class="col-md-6 cta-button">
                                <button type="submit" class="btn btn-lg btn-block btn-edit">Add new Interest</button>
                            </div>
                        </form>
                    </div>
                </div>
        ...
        <div class="bs-calltoaction bs-calltoaction-success">
            <div class="row">
                <div class="col-md-5 cta-contents">
                    <h1 class="cta-title">Add new Event</h1>
                    <div class="cta-desc">
                        <p>Describe the action here.</p>
                        <p>Describe the action here.</p>
                        <p>Describe the action here.</p>
