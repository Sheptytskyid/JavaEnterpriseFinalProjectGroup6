    ...
    <div class="row">
        ...
        <div class="col-xs-12 col-md-7 col-md-offset-1 col-lg-8">
            ...
            <div class="item">
                <div class="thumbnail">
                    <div>
                        <a href="#"><h3>Project description</h3></a>
                        <hr>
                    </div>
                    <div class="caption">
                ...
                <div class="hidden-lg hidden-md">
                    ...
                    <div class="panel price panel-danger">
                        <div class="panel-heading  text-center">
                            <h4><strong>Min investment</strong> $10000</h4>
                        </div>
                        <div class="panel-body text-center">
                            <h4>Total project investment $100000</h4>
                            <div class="progress">
                                <div class="progress-bar progress-bar-info" style="width: 20%"></div>
                            </div>
                            <h4 class="text-right">Project need $80000</h4>
            ...
            <div class="item">
                ...
                <div class="panel price panel-danger">
                    <div class="panel-heading">
                        ...
                        <h3 class="text-right">$10000</h3>
                    </div>
                    <div class="panel-body text-right">

                        <h5>Total project investment $100000</h5>
                        <div class="progress">
                            <div class="progress-bar progress-bar-info" style="width: 20%"></div>
                        </div>
                        <h5>Project need $80000</h5>
                        <!--todo list of investments for project creator-->
                    </div>
                    <div class="panel-footer">
                        <button type="button" class="btn btn-success btn-block" data-toggle="modal"
